...
hideOptionMenu:function(){WeixinJSBridge.call("hideOptionMenu")},showToolbar:function(){WeixinJSBridge.call("showToolbar")},hideToolbar:function(){WeixinJSBridge.call("hideToolbar")},getNetworkType:function(b){b&&"function"==typeof b&&WeixinJSBridge.invoke("getNetworkType",{},function(a){b(a.err_msg)})},imagePreview:function(b,a){b&&a&&0!=a.length&&WeixinJSBridge.invoke("imagePreview",{current:b,urls:a})},closeWindow:function(){WeixinJSBridge.call("closeWindow")}}}();var LB={random:function(b,a){return Math.floor(Math.random()*(a-b+1)+b)}},cc=cc||{},LB=LB||{},EmptyScene=cc.Scene.extend({onEnter:function(){this._super();cc.director.runScene(cc.TransitionFade.create(.5,new LB.StartupScene,cc.color(0,0,0)))}});
window.onload=function(){cc.game.onStart=function(){cc.Director._getInstance().setDisplayStats(!1);cc.view.adjustViewPort(!0);cc.sys.isMobile?cc.view.setDesignResolutionSize(320,480,cc.ResolutionPolicy.FIXED_WIDTH):cc.view.setDesignResolutionSize(320,480,cc.ResolutionPolicy.SHOW_ALL);cc.view.resizeWithBrowserSize(!0);cc.director.runScene(new EmptyScene)};cc.game.run("game_canvas")};cc=cc||{};LB=LB||{};WeixinApi=WeixinApi||{};LB.share_msg="\u6211\u6b63\u5728\u73a9 Line Boost\uff0c\u6839\u672c\u505c\u4e0d\u4e0b\u6765\uff01";LB.share_data={};LB.share_data.total_games=0;LB.call_php=function(b){var a=document.createElement("script");a.type="text/javascript";a.src=b;document.body.appendChild(a)};
...
LB.GameScene=cc.Scene.extend({onEnter:function(){this._super();var b=cc.director.getWinSize(),a=this;this.endGame=function(a){for(var b=0;4>b;b++)this.getChildByTag(10880+b).setEnabled(!1);this.unschedule(k);this.addChild(LB.GameOverDialogue.create(a,LB.gameTime-d,h),1E3)};var c=cc.LabelTTF.create("00","",48);c.setPosition(b.width/2,.9*b.height);c.setColor(cc.color(64,255,64));this.addChild(c,100);var d=LB.gameTime,g=cc.LabelTTF.create(d.toFixed(1).toString()+" s","",36);g.setPosition(b.width/
2,.8*b.height);g.setColor(cc.color(64,255,64));this.addChild(g,100);var k=function(a){d-=a;g.setString(d.toFixed(1).toString()+" s");0>d&&(d=0,this.endGame("Time up!!"))},e=LB.Track.create();e.appendTournant(0,0);e.setPosition(b.width/2,b.height/2);this.addChild(e);var f=LB.Track.create();f.themeColour=cc.color(0,128,255);f.appendTournant(0,0);e.addChild(f);var p=LB.board.direction.UP,q=cc.p(-200,0),n=[cc.p(-1,0),cc.p(0,0)];LB.board.used=[];var r=function(){var a=LB.board.generate(LB.pointsPerGeneration,
n[n.length-1],q,LB.direction_towards(n[n.length-2],n[n.length-1]));a.shift();for(l=0;l<a.length;l++)e.appendTournant(a[l].x,a[l].y),n.push(a[l])};r();n.shift();var p=LB.direction_towards(n[0],n[1]),q=cc.p(0,0),m=cc.Sprite.create("res/arrow.png");m.setAnchorPoint(cc.p(.5,0));e.addChild(m);var h=0,t=[[3,0,0,2],[2,1,1,3],[0,2,2,1],[1,3,3,0]],s=[270,90,0,180];m.setRotation(s[p]);for(var u=function(d){0==h&&a.schedule(k,.1);p=t[p][d];m.setRotation(s[p]);q=cc.pAdd(q,LB.board.move[p]);m.setPosition(LB.dataPosToGLPos(q));
e.runAction(cc.EaseSineOut.create(cc.MoveTo.create(.15,cc.pSub(cc.p(b.width/2,b.height/2),LB.dataPosToGLPos(q)))));cc.pEqual(q,e.tournants[++h])?c.setString((10>h?"0":"")+h.toString()):(f.themeColour=cc.color(255,64,64),m.setColor(cc.color(128,128,128)),h--,a.endGame("Ouch!!"));f.appendTournant(q.x,q.y);h%LB.pointsPerGeneration==LB.pointsPerGeneration-LB.board.max_visible_points&&r();return!0},l=0;4>l;l++)this.addChild(LB.control_button(l,u),100,10880+l),this.addChild(LB.control_button_sprite(l),
101)}});cc=cc||{};LB=LB||{};LB.come_on_share=["\u597d\u4e1c\u897f\u8981\u548c\u5927\u5bb6\u5206\u4eab","\u6652\u6210\u7ee9","\u6210\u7ee9\u4e0d\u9519\uff1f\u6233\u8fd9\u73a9\u610f\uff01","\u5f88\u597d\u73a9\u5bf9\u4e0d\u5bf9\uff1f"];
LB.rank=[[-12138,"\u672a\u5b8c\u6210\u6e38\u620f\uff0c\u65e0\u6cd5\u8bc4\u4ef7 T^T","\u575a\u6301\u5230\u5e95\u5c31\u80fd\u6709\u8bc4\u4ef7\u4e86\u554a (^ ^;)","\u8c8c\u4f3c\u6ca1\u6709\u523020\u79d2 (-_-)zzz","\u6491\u8fc720\u79d2\uff0c\u8fd9\u91cc\u4f1a\u6709\u597d\u4e1c\u4e1c\u5594 :-P","\u60f3\u79c0\u6210\u7ee9\uff1f\u5148\u4fdd\u8bc1\u4e0d\u201c\u6389\u7ebf\u201d\uff01 :)"],[0,"\u7a7a\u6c14","1%\u7684\u751f\u7269","\u6240\u6709\u975e\u751f\u7269","\u73ca\u745a","\u6240\u6709\u7684\u5fae\u751f\u7269"],
...
a.length-1)],LB.share_msg="\u6211\u5728Line Boost\u4e2d\u575a\u6301\u5230\u5e95\u5e76\u901a\u8fc7\u4e86"+this.score+"\u4e2a\u70b9\uff0c\u8d85\u8fc7\u4e86"+this.rank+"\uff01\u6c42\u8d85\u8d8a\uff01\uff01"):(this.rank="",LB.share_msg="\u6211\u5728Line Boost\u4e2d\u7528"+this.time+"\u79d2\u901a\u8fc7\u4e86"+this.score+"\u4e2a\u70b9\uff0c\u4e0d\u8fc7\u62fc\u4e86\u8001\u547d\u4e5f\u6ca1\u575a\u6301\u5230\u5e95\uff01\u4f60\u4e5f\u6765\u8bd5\u8bd5\uff1f");a=cc.LabelTTF.create(this.title,"",48);a.setPosition(b.width/
2,.9*b.height);a.setColor(cc.color(255,64,64));this.addChild(a);var c=cc.LabelTTF.create("\u6e38\u620f\u7ed3\u675f\uff01\n \n\u8017\u65f6\uff1a\n \n\u5f97\u5206\uff1a\n \n\u5e73\u5747\u901f\u5ea6\uff1a","",30,cc.size(b.width,0));c.setAnchorPoint(cc.p(.5,1));c.setPosition(b.width/2,.85*b.height);this.addChild(c);var d=cc.LabelTTF.create("","",44);d.setPosition(.6*b.width,.67*b.height);d.setVisible(!1);this.addChild(d);var g=cc.LabelTTF.create("","",44);g.setPosition(.6*b.width,.53*b.height);g.setVisible(!1);
this.addChild(g);var k=cc.LabelTTF.create(this.speed+"/s","",36);k.setPosition(.7*b.width,.39*b.height);k.setVisible(!1);this.addChild(k);var e=cc.Sprite.create("res/share.png");e.setAnchorPoint(cc.p(1,1));e.setPosition(b.width,b.height);e.setVisible(!1);this.addChild(e);a=cc.LabelTTF.create(LB.come_on_share[LB.random(0,LB.come_on_share.length-1)],"",16);a.setAnchorPoint(cc.p(.6,1));a.setPosition(0,0);a.setRotation(10);e.addChild(a);var f=-1,p=function(a){f+=a;2.4<f?(this.unschedule(p),
e.setVisible(!0),k.setVisible(!0),""==this.rank?c.setString(c.getString()+"\n"+LB.rank[0][LB.random(1,LB.rank[0].length-1)]):c.setString(c.getString()+"\n\u8d85\u8fc7\u4e86"+this.rank)):1<f?(a=(Math.min(f,1.6)-1)/.6,g.setVisible(!0),g.setString((this.score*a).toFixed(0))):0<f&&(a=Math.min(f,.6)/.6,d.setVisible(!0),d.setString((this.time*a).toFixed(2)+" s"))};this.schedule(p,0);LB.call_php("php/score_stat.php?time="+LB.share_data.time+"&score="+LB.share_data.score+"&total_games="+
LB.share_data.total_games);a=cc.MenuItemLabel.create(cc.LabelTTF.create("\u518d\u6765\u4e00\u6b21","",32),function(){cc.director.runScene(cc.TransitionFade.create(1,new LB.GameScene,cc.color(0,0,0)))},this);a.setPosition(b.width/2,.15*b.height);b=cc.Menu.create(a);b.setPosition(cc.p(0,0));this.addChild(b)}});LB.GameOverDialogue.create=function(b,a,c){var d=new LB.GameOverDialogue;d.time=a;d.score=c;d.title=b;return d};cc=cc||{};LB=LB||{};
...
LB.board={direction:{LEFT:0,RIGHT:1,UP:2,DOWN:3},turn_direction:[[2,3],[2,3],[0,1],[0,1]],move:[cc.p(-1,0),cc.p(1,0),cc.p(0,1),cc.p(0,-1)],turn_possib:.25,visible_range:cc.p(1.6,2.4),max_visible_points:15,used:[],generate:function(b,a,c,d){var g=[],k=0,e=0;LB.board.used[a.x]&&(LB.board.used[a.x][a.y]=!1);for(var f=function(a,b,d){if(0===a)return!0;if(Math.abs(b.x-c.x)<=LB.board.visible_range.x&&Math.abs(b.y-c.y)<=LB.board.visible_range.y||LB.board.used[b.x]&&LB.board.used[b.x][b.y])if(0<
k)k--;else return!1;var e,m;if(Math.random()<LB.board.turn_possib){var h=LB.random(0,1);e=LB.board.turn_direction[d][h];m=LB.board.turn_direction[d][1-h]}else h=LB.random(0,1),e=d,m=LB.board.turn_direction[d][h],d=LB.board.turn_direction[d][1-h];g.push(b);void 0===LB.board.used[b.x]&&(LB.board.used[b.x]=[]);LB.board.used[b.x][b.y]=!0;if(f(a-1,cc.pAdd(b,LB.board.move[e]),e)||f(a-1,cc.pAdd(b,LB.board.move[m]),m)||f(a-1,cc.pAdd(b,LB.board.move[d]),
d))return!0;g.pop();return!1};!f(b,a,d);)k=++e;return g}};
